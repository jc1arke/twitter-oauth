...
session_start();
require_once('twitter_lib/twitter.oauth.php');
...
$connection = new TwitterOAuth( $config["twitter"]["twitter_api_key"], $config["twitter"]["twitter_consumer_secret"], $access_token['oauth_token'], $access_token['oauth_token_secret']);
...
/* oauth/request_token */
$oauth = new TwitterOAuth($config["twitter"]["twitter_api_key"], $config["twitter"]["twitter_consumer_secret"]);
